    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'data' ? 'http://localhost:4001/api/v1/users/updateuser' : 'http://localhost:4001/api/v1/users/updatepassword'; //console.log(data);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return axios("http://localhost:4001/api/v1/bookings/checkout-session/".concat(tourid));
...
var bookbtn = document.getElementById('tour-booked'); //console.log(logoutbtn);form-user-settings
...
if (bookbtn) {
  bookbtn.addEventListener('click', function (e) {
    var id = e.target.dataset.tourid;
    console.log(id);
    checkout(id);
  });
}
