...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>".concat(loc.day, ":").concat(loc.description, "</p>")).addTo(map); //Extend the map bound to include the current location
...
},{}],"usersetting.js":[function(require,module,exports) {
"use strict";
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'data' ? '/api/v1/users/updateuser' : '/api/v1/users/updatepassword'; //console.log(data);
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              alert("".concat(type === 'data' ? "data" : "password", " updated successfully"));
...
},{"axios":"../../node_modules/axios/index.js"}],"stripes.js":[function(require,module,exports) {
"use strict";
...
var stripe = Stripe('pk_test_51Ij8OXSH1C37cGzWl4sThDGLUSkTp35GzORiGv2WIeJ6nXOARfpy8DkePzakttixwU7j0IaqVyTdM5h3XowWgAb200xXYtgWew');
...
var _require2 = require('./mapbox'),
    displayMap = _require2.displayMap;

var _require3 = require('./usersetting.js'),
    updatedata = _require3.updatedata;

var _require4 = require('./stripes'),
    checkout = _require4.checkout;

var mapBox = document.getElementById('map');
var loginForm = document.querySelector('.form--login');
var logoutbtn = document.querySelector('.nav__el--logout');
var submitdatabtn = document.querySelector('.form-user-data');
var updatepassword = document.querySelector('.form-user-settings');
var bookbtn = document.getElementById('tour-booked');
var signup = document.querySelector('.form--signup'); //console.log(logoutbtn);form-user-settings
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              confirmpassword = document.getElementById('password-confirm').value; //console.log(name,email);
...
if (bookbtn) {
  bookbtn.addEventListener('click', function (e) {
    ...
    var id = e.target.dataset.tourid; //  console.log(id);
...
var alert1 = document.querySelector('body').dataset.alert;
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "54083" + '/');
